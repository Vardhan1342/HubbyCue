    ...
    <section>
          ...
          <div className="relative mb-6 flex " >
            <input
              ...
              />
              <button className='absolute right-2 top-2' onClick={()=>{setShow(!show)}}>
         ...
         {signin ?<> 
          ...
          :<div className='text-center pb-6'><p className='text-gray-400 text-sm'>By continuing, you agree to our <span className='text-black'>Terms of Service </span> and <span className='text-black'>Privacy Policy</span>. </p></div>}
          <button
              type="button"
