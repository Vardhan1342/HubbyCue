      ...
      <nav className="flex items-center justify-between h-[100%]  md:mx-28">
        <section className="flex items-center gap-x-10">
          <Link href="/">
            ...
            />
            <Image
              src="https://hobbycue.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-small.50a121fa.png&w=48&q=75"
              width="36"
              height="60"
              alt="head"
          ...
          <div>
            <div className="hidden md:flex relative">
              <input
                type="text"
                className="bg-gray-200/50 border-[1.5px] w-0 lg:w-[300px] p-2 pr-[50px] text-sm rounded-xl border-[#8064a2] focus:outline-none"
        ...
        <section>
          ...
          <ul className="flex items-center gap-x-8">
            ...
            <li className="md:hidden flex cursor-pointer">
              <CiSearch size="25" color="#8064a2" />
            </li>
            <li className=" group hidden md:flex  justify-end items-center relative">
              <Link href="/" className="flex items-center space-x-2 ">
                <svg
                  ...
                  class=""
                >
                  <g clip-path="url(#clip0_10705_1996)">
                    <path
            ...
            <li className=" group flex  justify-end items-center relative ">
              <Link href="/" className="flex items-center space-x-1 ">
                <svg
                  ...
                  class=""
                >
                  <g clip-path="url(#clip0_10705_1999)">
                    <path
                ...
                <div className="  absolute z-50  w-full -bottom-8 -left-4 ">
            ...
            <section className="md:hidden relative overflow-">
              ...
              {sidebar && (
                <div className="z-50  bg-white fixed w-2/3 h-[120vh]  -translate-x-[60vw]  top-0">
