      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {data.map((item) => {
          return (
            <>
              <div
                className={`group hover:bg-[${item.color}] hover:text-white flex flex-col border-[1.5px] p-4 text-left space-y-4 rounded-lg shadow-sm transition-all ease-in-out delay-75`}
              >
