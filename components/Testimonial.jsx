          ...
          <div className='m-8 flex flex-col-reverse space-x-4 md:flex-row items-center justify-center overflow-hidden'>
            <div className='flex space-x-4 w-fit md:w-full mr-10 justify-between rounded-2xl p-2 px-4 bg-[#8064a2] items-center'>
              <div className='bg-white w-fit rounded-full h-fit aspect-square'>
                <img alt="pause" width="40" height="24" src="https://hobbycue.com/_next/static/media/play_arrow.fd429e2b.svg" />
              </div>

              <div className='w-full rounded-lg '>
                <input className='w-full h-1 mb-4' type="range" max="100" step="0.1" value="0" />
              </div>
              <div className='w-fit'>
                <Image alt="TestimonialImg" width="60" height="60" className='rounded-full' src="/testimonial.png" />
              </div>
            </div>

            <div className='flex space-x-4 my-6 md:w-full justify-end'>
              <Image alt="TestimonialImg" width="60" height="60" className='rounded-full aspect-square object-contain'  loading='lazy' src="/testimonial.png" />
              <div className='flex flex-col space-y-2'>
                <p className='text-[#8c56ce] font-bold text-lg'>Shubha Nagarajan</p>
